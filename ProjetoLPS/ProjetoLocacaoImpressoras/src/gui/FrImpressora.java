...
public class FrImpressora extends javax.swing.JFrame {
    ...
    protected ArrayList<Impressora> arrayImpressora = new ArrayList();
    ...
    public FrImpressora() {
     ...
     public boolean validarCampos(){
        ...
        if(!this.txtModelo.getText().replace(" ", "").matches("[A-Za-z]+")){
     ...
     public void salvarImpressora(){
         ...
         impressora.setTipo(txtTipo.getText());
         impressora.setColorida(cbxColorida.isSelected());
         
         if(tipoEdicao == 'I')
             arrayImpressora.add(impressora);
     ...
     public void carregarTblImpressora(){
        ...
        for(int i=0; i<arrayImpressora.size(); i++){
            Object [] linha = {arrayImpressora.get(i).getId(), arrayImpressora.get(i).getNome(), arrayImpressora.get(i).getTipo(), 
            arrayImpressora.get(i).getMarca(), arrayImpressora.get(i).getModelo(), arrayImpressora.get(i).isColorida()}; 
      ...
      public void ExcluirImpressora(){
         ...
         if(tblImpressora.getSelectedRow() != -1){
             ...
             this.preencherForm();
             this.habDesabForm(false);
             if(JOptionPane.showConfirmDialog(rootPane, "Deseja Realmente Excluir a Impressora: " + impressora.getNome(), "Sistema Impressora", JOptionPane.YES_NO_OPTION) == 0){
                 arrayImpressora.remove(impressora);
                 this.carregarTblImpressora();
             }
     ...
     public Impressora buscarImpressora(int id){
         for(int i=0; i < arrayImpressora.size(); i++){
             if(arrayImpressora.get(i).getId() == id)
     ...
     public void preencherForm(){
        ...
        this.txtID.setText(String.valueOf(impressora.getId()));
        this.txtNome.setText(impressora.getNome());
        this.txtMarca.setText(impressora.getMarca());
        this.txtModelo.setText(impressora.getModelo());
        this.txtTipo.setText(impressora.getTipo());
        this.cbxColorida.setSelected(impressora.isColorida());
    }
     public Impressora consuImpressora(int id){
         for(int i=0; i < arrayImpressora.size(); i++){
             if(arrayImpressora.get(i).getId() == id){
                 this.preencherForm();
                 return arrayImpressora.get(i);   
     ...
     public void consultarImpressora(String nome){
        for(int i=0; 1<arrayImpressora.size(); i++){
            ...
            if(impressora.getNome().toUpperCase().contains(nome))
                for(int j=0; j < tblImpressora.getRowCount(); j++){
                    if((int)tblImpressora.getValueAt(j, 0) == impressora.getId()){
        ...
        pnlImpressoraLayout.setHorizontalGroup(
            ...
            .addGroup(pnlImpressoraLayout.createSequentialGroup()
                ...
                .addGroup(pnlImpressoraLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlImpressoraLayout.createSequentialGroup()
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(pnlImpressora, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
