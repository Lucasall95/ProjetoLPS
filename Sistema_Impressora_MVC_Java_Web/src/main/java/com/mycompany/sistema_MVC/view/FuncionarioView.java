...
import com.mycompany.sistema_MVC.controller.FuncionarioController;
...
public class FuncionarioView extends javax.swing.JFrame {
    protected ArrayList<Object []> arrayFuncionario = new ArrayList();
    protected Object [] funcionario;
    ...
    public void preencherForm(){
        ...
        if(tblFuncionario.getSelectedRow() != -1){
            ...
            this.txtID.setText(funcionario[0].toString());
            this.txtNome.setText(funcionario[1].toString());
            this.txtIdade.setText(funcionario[3].toString());
            this.txtCargo.setText(funcionario[4].toString());
            this.txtSalario.setText(funcionario[6].toString());
            this.ftxtCpf.setText(funcionario[5].toString());
            if(funcionario[2].toString().toCharArray()[0] == 'M')
    ...
    public void salvarFuncionario(){
        ...
        Object [] funcionario = new Object[7];
        
        funcionario[0] = txtID.getText();
        funcionario[1] = txtNome.getText();
        funcionario[2] = txtIdade.getText();
        funcionario[3] = cbxSexo.getItemAt(cbxSexo.getSelectedIndex());
        funcionario[4] = ftxtCpf.getText();
        funcionario[5] = txtCargo.getText();
        funcionario[6] = txtSalario.getText();
        
        if(tipoEdicao == 'I')
            if(funcionarioController.incluirFuncionario(funcionario) > 0)
                JOptionPane.showMessageDialog(rootPane, "Funcionario cadastrado com Sucesso!");
            else
                JOptionPane.showMessageDialog(rootPane, "Erro ao Cadastrar o Funcionario.");
        else
            if(funcionarioController.modificarFuncionario(funcionario) > 0)
                JOptionPane.showMessageDialog(rootPane, "Funcionario alterado com Sucesso!");
            else
                JOptionPane.showMessageDialog(rootPane, "Erro ao alterar o Funcionario.");
    ...
    public void carregarTblFuncionario(){
        ...
        arrayFuncionario = funcionarioController.buscarFuncionario();
        
        for(int i=0; i<arrayFuncionario.size(); i++){
            Object [] linha = {arrayFuncionario.get(i)[0], arrayFuncionario.get(i)[1], arrayFuncionario.get(i)[2], 
            arrayFuncionario.get(i)[3], arrayFuncionario.get(i)[4], arrayFuncionario.get(i)[5], arrayFuncionario.get(i)[6]};
            model.addRow(linha);
        }
   ...
   public Object [] buscarFuncionario(int id){
        for(int i=0; i < arrayFuncionario.size(); i++){
            if((int)arrayFuncionario.get(i)[0] == id)
     ...
     public void excluirFuncionario(){
        ...
        if(tblFuncionario.getSelectedRow() != -1){
            ...
            preencherForm();
            this.habDesabForm(false);
            if(JOptionPane.showConfirmDialog(rootPane, "Deseja realmente excluir o(a) Funcionario: "  + funcionario[1],  "Sistema Funcionario", JOptionPane.YES_NO_OPTION) == 0){
                if(funcionarioController.removerFuncionario(funcionario)> 0){
                    JOptionPane.showMessageDialog(rootPane, "Funcionario (" + funcionario[1] + ") excluído com Sucesso!");
                    limparDados();
                    this.carregarTblFuncionario();
                }else
                    JOptionPane.showMessageDialog(rootPane, "Erro ao excluir o Funcionario"+ funcionario[1] + "!");
            }
        }
    }
     ...
     public void consultarFuncionario(String nome){
        for(int i=0; 1<arrayFuncionario.size(); i++){
            ...
            if(funcionario[1].toString().toUpperCase().contains(nome))
                for(int j=0; j < tblFuncionario.getRowCount(); j++){
                    if((int)tblFuncionario.getValueAt(j, 0) == (int)funcionario[0]){
